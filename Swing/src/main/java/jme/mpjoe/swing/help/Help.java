    ...
    private class HelpAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent ae) {
            try {
                ...
                URL url = getClass().getResource("/jme/mpjoe/swing/help/index.html");
                //URL url = ClassLoader.getSystemResource("/jme/mpjoe/swing/help/index.html"); // Das ist wohl eine Alternative

                if (url != null) {
                    File tempFile = File.createTempFile("MpjoeHelp", ".html");
                    tempFile.deleteOnExit();
                    //System.out.println("TMP=" + tempFile.toString());
                    InputStream is = getClass().getResourceAsStream("/jme/mpjoe/swing/help/index.html");
