...
public class JTableColumnFitAdapter extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getClickCount() == 2) {
            ...
            // Joe: Das +1 habe ich dazu getan, weil unter Linux der Text rechtsseitig sonst (halb) am Rahmen klebte.
            // Unter Windows war es auch ohne ok, auf Mac wohl auch
            tableColumn.setWidth(width + table.getIntercellSpacing().width + 1);
        }
    }
